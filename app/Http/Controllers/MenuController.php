...
class MenuController extends Controller
{
    ...
    public function order($idMenu, $idSwap){
        ...
        try{
            $menu->save();
            $swap->save();
            return redirect(route('menu.index'))->with('pesan',['success','Berhasil ubah uratan menu']);
        }catch(\Exception $e){
            return redirect(route('menu.index'))->with('pesan',['danger','Gagal ubah uratan menu']);
